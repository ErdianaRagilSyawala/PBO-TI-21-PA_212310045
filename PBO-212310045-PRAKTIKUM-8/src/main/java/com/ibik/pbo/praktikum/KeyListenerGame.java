...
public class KeyListenerGame extends JFrame implements KeyListener {
    ...
    private void GenerateGamesUI(KeyListenerGame frame) {
        // Initialize URL attribute for images folder path
        m_up = KeyListenerGame.class.getClassLoader().getResource(images_path + "maxwell_up.png");
        m_down =  KeyListenerGame.class.getClassLoader().getResource(images_path + "maxwell_down.png");
        m_left = KeyListenerGame.class.getClassLoader().getResource(images_path + "maxwell_left.png");
        m_right = KeyListenerGame.class.getClassLoader().getResource(images_path + "maxwell_right.png");
